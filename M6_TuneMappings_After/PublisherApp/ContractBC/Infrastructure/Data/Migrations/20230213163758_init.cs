        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specs_PriceForAddlAuthorCopiesUSD = table.Column<decimal>(type: "decimal(7,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractVersions_Author", x => new { x.ContractVersionId, x.Id });
                    table.ForeignKey(
                        name: "FK_ContractVersions_Author_ContractVersions_ContractVersionId",
