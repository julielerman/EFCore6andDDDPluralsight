...
namespace ContractBC.ValueObjects
{
    public class Author
    {
        ...
        public static Author UnsignedAuthor(string firstName, string lastName,string email,string phone)
        {
            return new Author(firstName, lastName,email,phone, false, Guid.Empty);
        }

        public static Author SignedAuthor(string firstName, string lastName,  string email,string phone,Guid signedAuthorId)
        {
            return new Author(firstName, lastName, email, phone, true, signedAuthorId); ;
        }

        private Author(string firstName, string lastName, string email, string phone,bool signed, Guid signedId)
        {
